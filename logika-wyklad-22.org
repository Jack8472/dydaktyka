...
- Język - system obejmujący zbiór znaków słownych. Języki naturalne i języki sztuczne. Żargon - w tym żargon prawniczy: domieszka do języka naturalnego.
...
- Nazwa, to coś co nadaje się na podmiot lub na orzecznik orzeczenia imiennego w zdaniu: /prawnik, planeta, sędzia/.
...
- Sędzia \(\type{n}\)
- przesłuchuje \(\frac{z}{nn}\)
- świadka. \(\type{n}\)

- Nieprawda, że \(\frac{z}{z}\)
- świeci \(\frac{z}{n}\)
- słońce. \(\type{n}\)
...
- Ta dziewczyna puściła do Ciebie oczko.
