#+title: Logika - notatka pomocnicza do ćwiczeń (2023/2024)
...
1. Gdzie znajdę ten materiał: https://github.com/szczerbowski/dydaktyka
2. kod MS Teams: =g8fg6vl=
...
#+CAPTION: Stostunki pomiędzy zakresami nazw (źródło: Z. Ziembiński, /Logika praktyczna/, Warszawa 1999, s. 42):
  [[./img/nazwy.jpeg]]

#+CAPTION: Stosunki pomiędzy zakresami nazw - wersja rozszerzona (źródło: Nazwa [online]. Wikipedia : wolna encyklopedia, 2020-04-14 02:21Z [dostęp: 2020-10-30 13:36Z]. Dostępny w Internecie: //pl.wikipedia.org/w/index.php?title=Nazwa&oldid=59402236):
[[./img/relacje-nazw-wiki.jpg]]
...
Czy jest jakiś algorytm tworzenia par nazw podprzeciwnych?
